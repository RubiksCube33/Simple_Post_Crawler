...
def make_url(querry):
    readurl = 'https://service.epost.go.kr/trace.RetrieveDomRigiTraceList.comm?sid1='
    return readurl + querry + "&displayHeader=N"
...
class crawler():
    ...
    def save_screenshot_withhout_masking(self, querry, out_dir, key1, key2, receiver_name):
        url = make_url(querry)
        self.driver.get(url)
        ...
        self.driver.save_screenshot(out_dir + "/" + receiver_name + " " + querry + ".png")

    def unlock_masking(self, key1, key2):
        button_location = (575, 330)
        #time.sleep(0.1)
